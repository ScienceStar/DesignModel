    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.project");
                servletContext.setInitParameter("tapestry.development-modules", "com.project.services.DevelopmentModule");
